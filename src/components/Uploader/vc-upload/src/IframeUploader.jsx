...
const IframeUploader = {
  ...
  methods: {
    ...
    getIframeHTML (domain) {
      ...
      <style>
      body,html {padding:0margin:0border:0overflow:hidden}
      </style>
      ${domainScript}
      </head>
      <body>
      ...
      action="" id="form"
      style="display:blockheight:9999pxposition:relativeoverflow:hidden">
      <input id="input" type="file"
       name="${this.name}"
       style="position:absolutetop:0right:0height:9999pxfont-size:9999pxcursor:pointer"/>
      ${domainInput}
      <span id="data"></span>
      </form>
      </body>
