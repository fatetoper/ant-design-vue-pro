...
const VuePropTypes = {
  ...
  shape (obj) {
    ...
    // toType ==>Adds `isRequired` `_vueTypes_name`(=`shape`) and `def` modifiers to an object
    const type = toType('shape', {
      ...
      validator (value) {
        ...
        return valueKeys.every(key => {
          ...
          const type = obj[key]
          // validateType==> Validates a given value against a prop type object
